...
const content = {
  en: {
    ...
    intro: "Located in the serene heart of the Phulwaria block in the Gopalganj district of Bihar, Songadhwa (also known as Songharwa) is a beautiful, tight-knit community grounded in rich agrarian roots, shared values, and centuries-old cultural traditions. Guided by our local PIN code 841425, our village seamlessly balances peaceful rural life with a vibrant, modernizing outlook.",
    ...
    temple1desc: "The heart of our community, especially during the Dhol Mela, where youth gather to offer prayers and Nishan (holy flags) before processions.",
    temple2placeholder: "Songadhwa Hanuman Mandir",
    temple2desc: ": A peaceful spiritual spot where village families gather every morning and evening for daily prayers and community discussions.",
    education: "Education & Services",
    school1: "Our Village Schools:",
    school1desc: "Songadhwa is home to",
    schoolPlaceholder: "Rajkiya Madhya Vidyalaya Bairagitola (Songadhwa)",
    ...
    proud1desc: "Widely recognized across Gopalganj district for the legendary Songadhwa Akhra No-7 Dhol Mela — the discipline, bravery, and grandeur of the annual parade make the village a symbol of pride for miles around.",
  ...
  hi: {
    ...
    temple2placeholder: "सोनगढ़वा हनुमान मंदिर",
    temple2desc: ": एक शांतिपूर्ण आध्यात्मिक स्थान जहां गांव के परिवार हर सुबह और शाम दैनिक प्रार्थना और सामुदायिक चर्चा के लिए एकत्र होते हैं।",
    education: "शिक्षा और सेवाएं",
    school1: "हमारे गांव के स्कूल:",
    school1desc: "सोनगढ़वा",
    schoolPlaceholder: "राजकीय मध्य विद्यालय बैरागीटोला (सोनगढ़वा) ",
    school1desc2: "का घर है, जो गांव के भीतर ही एक मजबूत शैक्षिक आधार सुनिश्चित करता है।",
    school2: "सोनगढ़वा डाकघर और सेवाएं:",
    ...
    proud1desc: "पौराणिक सोनगढ़वा अखाड़ा नंबर 7 ढोल मेला के लिए पूरे गोपालगंज जिले में व्यापक रूप से मान्यता प्राप्त — वार्षिक परेड का अनुशासन, वीरता और भव्यता गांव को मीलों तक गर्व का प्रतीक बनाती है।",
    ...
    proud3: "मेहनती भावना:",
    proud3desc: "क्षेत्र को खिलाने वाले किसानों से लेकर प्रमुख शहरों में करियर बनाने वाले युवा पेशेवरों तक, सोनगढ़वा के लोग ईमानदारी, दृढ़ता और अटूट कार्य नीति के लिए जाने जाते हैं।",
  },
};
