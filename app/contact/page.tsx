  ...
  return (
    <main className="bg-ivory min-h-screen">
      ...
      <section className="max-w-xl mx-auto px-4 py-16">
        ...
        {status === "sent" ? (
          <div className="card flex flex-col items-center gap-2 p-8 text-center border-gold-light/40">
            <CheckCircle2 className="text-maroon w-10 h-10" />
            <p className="text-maroon font-medium">{t.thanks}</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="card p-6 space-y-4">
            <input
              ...
              className="w-full border border-maroon-light/25 rounded-lg px-4 py-2 bg-white text-charcoal placeholder:text-charcoal/40 focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold"
              required
            />
            <input
              type="email"
            ...
            <textarea
              ...
              className="w-full border border-maroon-light/25 rounded-lg px-4 py-2 h-32 bg-white text-charcoal placeholder:text-charcoal/40 focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold"
              required
            />
            <button
              type="submit"
              disabled={status === "sending"}
              className="w-full flex items-center justify-center gap-2 bg-maroon text-white px-6 py-2.5 rounded-lg font-medium hover:bg-maroon-dark transition-colors disabled:opacity-50"
            >
